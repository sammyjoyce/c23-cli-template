...
static command_result_t run_cli(test_context_t *ctx, const char *const *args,
...
static bool expect_exit(const command_result_t *result, int expected) {
...
static bool expect_not_exit(const command_result_t *result, int unexpected) {
...
static bool expect_stdout_contains(const command_result_t *result,
                                   const char *needle) {
  return expect_contains(result, "stdout", result->out, needle);
}

static bool expect_stderr_contains(const command_result_t *result,
                                   const char *needle) {
  return expect_contains(result, "stderr", result->err, needle);
}

static bool expect_stdout_empty(const command_result_t *result) {
...
static bool write_temp_config(const char *content, char **path_out) {
  temp_file_t file;
